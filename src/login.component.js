...
var LoginComponent = function () {
    var _classDecorators = [(0, core_1.Component)({
            ...
            imports: [router_1.RouterLink, forms_1.FormsModule, common_1.CommonModule],
        })];
    ...
    var LoginComponent = _classThis = /** @class */ (function () {
        function LoginComponent_1() {
            ...
            this.errorHandlerService = (0, core_1.inject)(error_handler_service_1.ErrorHandlerService);
        ...
        LoginComponent_1.prototype.loginWithGoogle = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.authService.retryAuthOperation(function () {
                                    return _this.authService.loginWithGoogle('login');
                                })];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 5];
                        case 3:
                            ...
                            if (error_1.message === "Account does not exist. Please sign up.") {
                                this.router.navigate(['/account-not-found']);
                            }
                            else {
                                this.errorHandlerService.handleAuthError(error_1, {
        ...
        LoginComponent_1.prototype.loginWithEmail = function () {
            return __awaiter(this, void 0, void 0, function () {
                var error_2;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, 4, 5]);
                            return [4 /*yield*/, this.authService.retryAuthOperation(function () {
                                    return _this.authService.loginWithEmail(_this.email, _this.password);
                                })];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 5];
                        case 3:
                            ...
                            this.errorHandlerService.handleAuthError(error_2, {
                                component: 'LoginComponent',
        ...
        Object.defineProperty(LoginComponent_1.prototype, "authLoading", {
        ...
        Object.defineProperty(LoginComponent_1.prototype, "authError", {
