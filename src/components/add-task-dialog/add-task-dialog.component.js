...
var AddTaskDialogComponent = function () {
    ...
    var AddTaskDialogComponent = _classThis = /** @class */ (function () {
        function AddTaskDialogComponent_1() {
            this.closed = __runInitializers(this, _closed_initializers, new core_1.EventEmitter());
            this.taskService = (__runInitializers(this, _closed_extraInitializers), (0, core_1.inject)(task_service_1.TaskService));
        ...
        AddTaskDialogComponent_1.prototype.close = function () {
            this.closed.emit();
        };
        AddTaskDialogComponent_1.prototype.onSubmit = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.taskService.addTask(this.task)];
                        case 2:
                            _a.sent();
        ...
        return AddTaskDialogComponent_1;
    }());
    __setFunctionName(_classThis, "AddTaskDialogComponent");
    (function () {
        ...
        AddTaskDialogComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AddTaskDialogComponent = _classThis;
}();
