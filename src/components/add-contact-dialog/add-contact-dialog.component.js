...
var AddContactDialogComponent = function () {
    ...
    var AddContactDialogComponent = _classThis = /** @class */ (function () {
        function AddContactDialogComponent_1() {
            this.closed = __runInitializers(this, _closed_initializers, new core_1.EventEmitter());
            this.contactService = (__runInitializers(this, _closed_extraInitializers), (0, core_2.inject)(contact_service_1.ContactService));
            this.toastService = (0, core_2.inject)(toast_service_1.ToastService);
            this.loading = false;
            this.contact = {
                name: '',
                email: '',
        ...
        AddContactDialogComponent_1.prototype.close = function () {
            this.closed.emit();
        };
        AddContactDialogComponent_1.prototype.onSubmit = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.contactService.addContact(this.contact)];
                        case 2:
                            _a.sent();
        ...
        return AddContactDialogComponent_1;
    }());
    __setFunctionName(_classThis, "AddContactDialogComponent");
    (function () {
        ...
        AddContactDialogComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AddContactDialogComponent = _classThis;
}();
