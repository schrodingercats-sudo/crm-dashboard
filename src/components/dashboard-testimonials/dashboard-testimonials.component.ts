...
import { LucideAngularModule, Twitter } from 'lucide-angular';
...
@Component({
    ...
    templateUrl: './dashboard-testimonials.component.html',
})
export class DashboardTestimonialsComponent {
    ...
    get displayedTestimonials() {
        return this.showAll ? this.testimonials : this.testimonials.slice(0, this.maxDisplayed);
    }
