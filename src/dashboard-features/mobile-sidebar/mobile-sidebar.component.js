...
exports.MobileSidebarComponent = void 0;
var core_1 = require("@angular/core");
var router_1 = require("@angular/router");
var navigation_service_1 = require("../../navigation.service");
var MobileSidebarComponent = function () {
    ...
    var _classThis;
    var MobileSidebarComponent = _classThis = /** @class */ (function () {
        function MobileSidebarComponent_1() {
            var _this = this;
            this.isOpen = core_1.input.required();
            this.close = (0, core_1.output)();
        ...
        MobileSidebarComponent_1.prototype.onLinkClick = function () {
            this.close.emit();
        };
        MobileSidebarComponent_1.prototype.toggle = function (id) {
            this.expandedState.update(function (state) {
                var _a;
                return (__assign(__assign({}, state), (_a = {}, _a[id] = !state[id], _a)));
            });
        };
        return MobileSidebarComponent_1;
    }());
    __setFunctionName(_classThis, "MobileSidebarComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        MobileSidebarComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MobileSidebarComponent = _classThis;
}();
