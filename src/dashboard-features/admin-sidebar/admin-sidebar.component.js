...
var AdminSidebarComponent = function () {
    ...
    var _classThis;
    var AdminSidebarComponent = _classThis = /** @class */ (function () {
        function AdminSidebarComponent_1() {
            var _this = this;
        ...
        AdminSidebarComponent_1.prototype.toggle = function (id) {
            this.expandedState.update(function (state) {
                var _a;
                return (__assign(__assign({}, state), (_a = {}, _a[id] = !state[id], _a)));
            });
        };
        return AdminSidebarComponent_1;
    }());
    __setFunctionName(_classThis, "AdminSidebarComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        AdminSidebarComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AdminSidebarComponent = _classThis;
}();
